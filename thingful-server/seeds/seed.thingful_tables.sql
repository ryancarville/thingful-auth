BEGIN;
  ...
  VALUES
    ('dunder', 'Dunder Mifflin', null, '$2a$12$IPUxVKMaHjHkmCHaFkf7NOswlK8honfVBJ22Cz.NwgxrMEs7F2KKW'),
    ('b.deboop', 'Bodeep Deboop', 'Bo', '$2a$12$kWiGoDDbvIgeluKl7gbAiecRWhkfX.0ieAtVnEDWL7s79mF5S/4pa'),
    ('c.bloggs', 'Charlie Bloggs', 'Charlie', '$2a$12$GP07EZjrU9pRbK7cD/IIgucMsWNSqYuGsZlh4ZcypeNcv1juH1nCC'),
    ('s.smith', 'Sam Smith', 'Sam', '$2a$12$QsynQmck5eKWZ/oKvYIuG.25m2H3n5Ol0ICYwous1iJbgJrbcOWKO'),
    ('lexlor', 'Alex Taylor', 'Lex', '$2a$12$RAvH4n3Sq0zlRvb1qNeRIOp1il0RV/L/gzDP7dqEwtBT5LQJTHy1q'),
    ('wippy', 'Ping Won In', 'Ping', '$2a$12$eI5Z4SxXlwAZqmcI4qS6Su61kootMjkE/6MHUMGOZwXSbzJ9HSHWC');
